...
function BoardColumn({ tasks, status, animationState }: { tasks: Task[], status: TaskStatus, animationState: AnimationState }): React.JSX.Element {
...
function BoardView({ tasks, animationByStatus }: { tasks: Task[], animationByStatus: Record<TaskStatus, AnimationState> }): React.JSX.Element {
  return (
