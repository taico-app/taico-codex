...
5. Copy `apps/ui2/dist` into `apps/backend/dist/public`
...
- `apps/backend` also serves the built `apps/ui2` files as static content

Frontend runtime:
- `apps/ui2` talks to `apps/backend`
- `apps/ui2` uses `packages/client` for API calls
- `apps/ui2` uses `packages/events` for shared event types
...
packages/client -----------> apps/ui2
packages/shared -----------> apps/ui2
packages/events -----------> apps/ui2

packages/client -----------> apps/worker
packages/shared -----------> apps/worker

apps/ui2/dist -------------> apps/backend/dist/public
```
